...
// gcc checkopts.c error.c error.h
...
static char *sock_str_int(union val *ptr, int len) {
    if (len != sizeof(int)) {
        ...
        snprintf(strres, sizeof(strres), "%s", (ptr->l_val == 0) ? "off" : "on");
    }
    return strres;
}
...
/*
    ...
    SO_ERROR: default = off
    SO_KEEPALIVE: default = off
    SO_LINGER: default = l_onoff = 0, l_linger = 0
    SO_OOBINLINE: default = off
    SO_RCVBUF: default = on
    SO_SNDBUF: default = on
    SO_RCVLOWAT: default = on
    SO_SNDLOWAT: default = on
    ...
    IP_TOS: default = off
    IP_TTL: default = on
    IPV6_DONTFRAG: Can't create fd for level 41
*/
