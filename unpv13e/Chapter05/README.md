...
![与同一个并发服务器建立了5个连接的客户](figure/5-8.png)

![客户终止，关闭5个连接，终止5个子进程](figure/5-10.png)
...
![从客户的角度总结TCP客户/服务器](figure/5-15.png)

![从服务器的角度总结TCP客户/服务器](figure/5-16.png)
